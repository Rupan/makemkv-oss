...
typedef struct {
  ...
  uint16_t cell_type        : 5;  /** for karaoke, reserved otherwise */
  uint8_t still_time;
  uint8_t cell_cmd_nr;
 ...
 */
typedef struct {
  uint32_t zero                           : 7; /* 25-31 */
  uint32_t video_pres_mode_change         : 1; /* 24 */

  uint32_t karaoke_audio_pres_mode_change : 1; /* 23 */
  uint32_t angle_change                   : 1;
  uint32_t subpic_stream_change           : 1;
  uint32_t audio_stream_change            : 1;
  uint32_t pause_on                       : 1;
  uint32_t still_off                      : 1;
  uint32_t button_select_or_activate      : 1;
  uint32_t resume                         : 1; /* 16 */

  uint32_t chapter_menu_call              : 1; /* 15 */
  uint32_t angle_menu_call                : 1;
  uint32_t audio_menu_call                : 1;
  uint32_t subpic_menu_call               : 1;
  uint32_t root_menu_call                 : 1;
  uint32_t title_menu_call                : 1;
  uint32_t backward_scan                  : 1;
  uint32_t forward_scan                   : 1; /* 8 */

  uint32_t next_pg_search                 : 1; /* 7 */
  uint32_t prev_or_top_pg_search          : 1;
  uint32_t time_or_chapter_search         : 1;
  uint32_t go_up                          : 1;
  uint32_t stop                           : 1;
  uint32_t title_play                     : 1;
  uint32_t chapter_search_or_play         : 1;
  uint32_t title_or_time_play             : 1; /* 0 */
