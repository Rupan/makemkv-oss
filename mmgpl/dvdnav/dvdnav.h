...
dvdnav_status_t dvdnav_set_nav_only_flag(dvdnav_t *self, int32_t nav_only);
 ...
 */
dvdnav_status_t dvdnav_current_title_program2(dvdnav_t *self, int32_t *title, int32_t* vtsn,
                                          int32_t *pgcn, int32_t *pgn,int32_t* celln);
